...
public class UpdateEmployeeRequest : IRequest<UpdateEmployeeResult>
{
...
public class UpdateEmployeeHandler : IRequestHandler<UpdateEmployeeRequest, UpdateEmployeeResult>
{
    ...
    public async Task<UpdateEmployeeResult> Handle(UpdateEmployeeRequest request, CancellationToken cancellationToken)
    {
